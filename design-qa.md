...
The implementation preserves the reference's warm off-white canvas, deep navy editorial typography, cobalt accents, split hero composition, technical Unreal-to-web visual, restrained navigation, and horizontal project-list treatment. Project facts and existing case-study routes were retained.
